...
"""Registers the schema for com.verily.heart_rate_variability with Beam."""
...
@dataspec('com.verily.heart_rate_variability')
@dataclasses.dataclass
class Heart_Rate_Variability(DataPoint):
    """Beam RowSchema for com.verily.heart_rate_variability."""
    sdnn: float
    time_interval: float
